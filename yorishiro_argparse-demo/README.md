...
`kotoba-lang/kotodama-mcp/yorishiro-argparse-demo-mcp/` (stdio + Streamable HTTP)
...
```json
{
  "mcpServers": {
    "etzhayyim-yorishiro-argparse-demo": {
      "command": "node",
      "args": ["/ABSOLUTE/PATH/TO/repo/kotoba-lang/kotodama-mcp/yorishiro-argparse-demo-mcp/src/cli.ts"]
    }
  }
}
```
