...
`kotoba-lang/kotodama-mcp/yorishiro-demo-fixture-mcp/` (stdio + Streamable HTTP)
...
```json
{
  "mcpServers": {
    "etzhayyim-yorishiro-demo-fixture": {
      "command": "node",
      "args": ["/ABSOLUTE/PATH/TO/repo/kotoba-lang/kotodama-mcp/yorishiro-demo-fixture-mcp/src/cli.ts"]
    }
  }
}
```
