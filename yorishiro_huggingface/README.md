...
`kotoba-lang/kotodama-mcp/yorishiro-huggingface-mcp/` (stdio + Streamable HTTP)
...
```json
{
  "mcpServers": {
    "etzhayyim-yorishiro-huggingface": {
      "command": "node",
      "args": ["/ABSOLUTE/PATH/TO/repo/kotoba-lang/kotodama-mcp/yorishiro-huggingface-mcp/src/cli.ts"],
